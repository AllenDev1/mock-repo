	...
	const navBarAnim = () => {
		if (window.innerWidth > 993) {
			if (window.scrollY > 30) {
				document.querySelector(".nav-footer-container").style.display =
					"none";
				document.querySelector(".upper-nav-sec").style.borderBottom =
					"none";
					...
					>
						<div className="total-hover">
							...
							>
								...
								<div class="dropdown-content">
									<a href="/vehicles/?active-nav=vehicle">
										All
									</a>
									...
									<a href="/scooters/?active-nav=vehicle">
										Scooters
									</a>
									<a href="/bicycle/?active-nav=vehicle">
										Bicycle
									</a>
						...
						<div className="total-hover">
							...
							>
								Properties
								<div class="dropdown-content">
									<a href="/properties/?active-nav=properties">
										All
									</a>
						...
						<div className="total-hover">
							...
							>
								...
								<div class="dropdown-content">
									...
									<a href="/tablets/?active-nav=mobile">
										Tablets
									</a>
									<a href="/wearables/?active-nav=mobile">
										Wearables
									</a>
						...
						<div className="total-hover">
							...
							>
								...
								<div class="dropdown-content">
									...
									<a href="/jobs/?active-nav=family-needs">
										Jobs
									</a>
									<a href="/foods/?active-nav=family-needs">
										Foods
									</a>
									<a href="/gifts/?active-nav=family-needs">
										Gifts
									</a>
								</div>
							</p>
						...
						<div className="total-hover">
							...
							>
								Services
								<div class="dropdown-content">
									<a href="/services/?active-nav=services">
										All
									</a>
									<a href="/cleaning/?active-nav=services">
										Cleaning
									</a>
						...
						<div className="total-hover ">
							...
							>
								Furnitures
								<div class="dropdown-content">
									<a href="/furnitures/?active-nav=furnitures">
										All
									</a>
									...
									<a href="/sofa/?active-nav=furnitures">
										Sofa sets
									</a>
						...
						<div className="total-hover">
							...
							>
								...
								<div class="dropdown-content">
									...
									<a href="/other/?active-nav=travels-trips">
										Other
									</a>
								</div>
							</p>
						...
						<div className="total-hover">
							...
							>
								...
								<div class="dropdown-content drop-r">
									...
									<a href="/charity/?active-nav=others">
										Charity
									</a>
									<a href="/others-other/?active-nav=others">
										Others
									</a>
								</div>
							</p>
